...
- (void)viewDidLoad {
    ...
    _ivImg = [[UIImageView alloc]initWithFrame:CGRectMake(0, (DEVICE_HEIGHT-DEVICE_WIDTH)/2.0-NAV_STATUS_HEIGHT, DEVICE_WIDTH, DEVICE_WIDTH)];
...
- (void) upload:(UIImage*)image {
    ...
    dispatch_async(global_queue, ^{
        ...
        if (myvCardTemp) {
            ...
            [xmppvCardTempModule activate: [XmppCenter shareInstance].xmppStream];
